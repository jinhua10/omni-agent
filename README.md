...
1. **master 分支保持稳定**：现有功能不受影响，可以继续使用
2. **refactor_01 分支为实验性**：新功能在此分支开发和测试
3. **数据兼容性**：重构完成后会提供自动迁移工具
4. **预计合并时间**：2-3个月后合并回 master 分支
