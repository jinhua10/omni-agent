...
- [BEHAVIOR_ANALYSIS_GUIDE.md](../worklog/BEHAVIOR_ANALYSIS_GUIDE.md) - 行为分析指南
- [P2P_SECURE_CONNECTION_GUIDE.md](../worklog/P2P_SECURE_CONNECTION_GUIDE.md) - P2P安全连接指南
...
- [FRAMEWORK_STATUS_REPORT.md](../worklog/FRAMEWORK_STATUS_REPORT_20251215.md) - 框架状态报告
