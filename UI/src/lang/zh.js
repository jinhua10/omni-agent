...
export default {
  ...
  document: {
    ...
    basicInfo: '基本信息',
    extractedText: '提取文本',
    loadingExtractedText: '正在加载提取文本...',
    loadError: '加载失败',
    noExtractedText: '该文档尚未提取文本内容',
  ...
  ragFlow: {
    ...
    component: {
      ...
      confirmDelete: '确认删除',
      confirmDeleteContent: '确定要删除策略模板 "{name}" 吗？此操作不可恢复。',
      templateDeleted: '模板已删除',
      deleteFailed: '删除失败',
      templateApplied: '策略模板已应用',
      applyFailed: '应用失败',
      pleaseSelectTextExtraction: '请先选择文本提取方式',
      pleaseSelectChunkingStrategy: '请先选择分块策略',
      cannotLoadConfig: '无法加载文档配置',
      loadConfigFailed: '加载配置失败',
      pleaseSelectDocument: '请先选择文档',
      pleaseEnterTemplateName: '请输入模板名称',
      templateSaved: '策略模板已保存',
      saveFailed: '保存失败',
      startProcessingDoc: '开始处理文档：',
      processingStarted: '开始处理...',
      documentFlowTitle: '文档处理流程：',
      previousStep: '上一步',
      nextStep: '下一步',
  ...
  textExtractionConfig: {
    ...
    buttons: {
      ...
      applyConfig: '应用配置',
      reset: '重置',
      resetSuccess: '已重置到原始提取结果',
      noOriginalResult: '没有可重置的原始结果',
      backToFlow: '返回流程视图',
      previousStep: '上一步：流程视图',
      reExtract: '重新提取',
      nextStep: '下一步：分块配置',
    },
  ...
  landingPage: {
    ...
    stats: {
      ...
      docFormats: '文档格式',
      docFormatsUnit: '类',
      chunkingStrategies: '分块方式',
      chunkingStrategiesUnit: '种',
      ragSolutions: 'RAG方案',
      ragSolutionsUnit: '种',
      vectorModels: '向量模型',
      vectorModelsUnit: '类',
      storageEngines: '存储引擎',
      storageEnginesUnit: '种',
      multiInstance: '多实例',
      multiInstanceUnit: '支持',
      modelIntegration: '模型接入',
      modelIntegrationUnit: '类',
      knowledgeNetwork: '知识网络',
      knowledgeNetworkUnit: '启用',
      hope: 'HOPE',
      hopeUnit: '启用',
      p2p: 'P2P',
      p2pUnit: '启用',
      ...
      // 统计说明文字
      desc1: '模块化设计 · 企业级代码质量',
      desc2: '多策略RAG · 灵活存储 · 支持多实例',
      desc3: '知识网络 · 自学习 · P2P分布式',
      desc4: '最新技术栈 · 开箱即用',
    },
    // 对比部分
    comparison: {
      title: '为什么选择 OmniAgent？',
      traditionalDefect: '❌ 传统RAG的根本性缺陷',
      singleVectorChaos: '单一向量空间混乱',
      mixedDocs: '📄 技术文档 + 📊 财务报表 + 💼 合同 + 📧 邮件...',
      // 问题点
      semanticFragmentation: '语义割裂',
      semanticFragmentationDesc: '固定分块破坏语义',
      contextBreak: '上下文断裂',
      contextBreakDesc: '跨块信息无法关联',
      vectorPollution: '向量空间污染',
      vectorPollutionDesc: '多领域混杂降低精度',
      singleStorage: '单一存储',
      singleStorageDesc: '存在单点故障',
      fixedDimension: '固定维度',
      fixedDimensionDesc: '无法适配不同场景',
      staticKnowledge: '静态知识',
      staticKnowledgeDesc: '缺乏持续学习',
      // 创新点
      innovation: '✅ OmniAgent的架构创新',
      domainIsolation: '知识域隔离架构',
      techDocDomain: '技术文档域',
      financeDomain: '财务报表域',
      contractDomain: '合同域',
      sixStrategies: '6种分块策略',
      semanticPreserved: '智能保留语义',
      domainIsolationFeature: '知识域隔离',
      independentVector: '独立向量空间',
      multiStorage: '多元存储',
      disasterBackup: '灾备冗余方案',
      multiDimension: '多维度向量',
      parallelEmbedding: '并行Embedding',
      knowledgeNetworkFeature: '知识网络',
      crossDomain: '跨域关联增强',
      hopeArch: 'HOPE架构',
      selfLearning: '自我学习进化',
      smartRole: '智能角色',
      aiPrompts: 'AI生成提示词',
      distributedArch: '分布式架构',
      highAvailability: '高可用集群',
    },
    // 工作流程
    workflow: {
      title: '智能化全流程',
      domainArchDetail: '知识域隔离架构详解',
      knowledgeNetworkLayer: '知识网络增强层',
      p2pArchTitle: 'P2P分布式架构 - 让知识在网络中传递',
      knowledgeExtraction: '知识提取',
      aiAnalysis: 'AI智能分析',
      crossDomainAssociation: '跨域关联',
      semanticGraph: '语义图谱构建',
      hopeLearning: 'HOPE学习',
      selfOptimization: '自我优化进化',
      contextCompletion: '上下文补全',
      qaEnhancement: '智能问答增强',
      // 步骤
      step1Title: '1. 文档上传',
      step1Highlight: '全格式支持',
      step1Detail1: '• Office: Word, Excel, PPT, PDF',
      step1Detail2: '• 文本: TXT, MD, JSON, XML, CSV...',
      step1Detail3: '• 代码: 所有编程语言',
      step2Title: '2. 智能提取',
      step2Highlight: '多引擎可选',
      step2Detail1: '• 本地模型: 离线处理',
      step2Detail2: '• Ollama: 本地部署',
      step2Detail3: '• 在线API: 千问3-VL等',
      step3Title: '3. 智能分块',
      step3Highlight: '6种策略可选',
      step3Detail1: '• 固定长度/段落/句子',
      step3Detail2: '• 困惑度智能分块（推荐）',
      step3Detail3: '• 语义分块（TF-IDF）',
      step4Title: '4. 向量化',
      step4Highlight: '多种方式并存',
      step4Detail1: '• ONNX本地模型: BGE系列',
      step4Detail2: '• Ollama: 本地向量化',
      step4Detail3: '• 在线API: OpenAI, 千帆...',
      step4Detail4: '✓ 支持多套RAG系统同时运行',
      step5Title: '5. 域索引构建',
      step5Highlight: '知识域隔离架构',
      step5Detail1: '• 按领域独立向量空间',
      step5Detail2: '• 避免跨域干扰',
      step5Detail3: '• 精准检索定位',
      step6Title: '6. 多次RAG检索',
      step6Highlight: '多策略并行',
      step6Detail1: '• 向量检索 + 关键词检索',
      step6Detail2: '• 结果融合与重排序',
      step6Detail3: '• 提高召回率和准确率',
      // 传统方式
      traditionalWay: '❌ 传统方式：单一索引池',
      traditionalDesc1: '所有文档混在一个向量空间',
      traditionalDesc2: '技术、财务、法律文档相互干扰',
      traditionalDesc3: '检索精度低，噪音多',
      // OmniAgent方式
      omniAgentWay: '✅ OmniAgent：知识域隔离',
      independentIndex: '独立索引',
      techDataDomain: '技术文档域',
      financeDataDomain: '财务数据域',
      legalContractDomain: '法律合同域',
      omniAgentDesc1: '每个领域独立向量空间',
      omniAgentDesc2: '互不干扰，精准检索',
      omniAgentDesc3: '检索精度提升50%+',
      // P2P部分
      ...
      knowledgePropagationDesc: '新知识自动推送到连接的节点，持续学习和进化',
      enterpriseNode: '企业节点',
      departmentA: '部门A',
      departmentB: '部门B',
      departmentC: '部门C',
    ...
    knowledgeNetworkArch: {
      title: '知识网络架构',
      subtitle: '角色驱动的完整知识提取 + 独立向量库 = 可控的智能检索',
      // 传统RAG问题
      traditionalTitle: '传统RAG的困境',
      problem1: '内容碎片化',
      problem1Desc: '固定分块破坏语义完整性，上下文丢失',
      problem2: '结果随机性',
      problem2Desc: '没有大规模训练，检索结果难以预测控制',
      problem3: '知识糅合混乱',
      problem3Desc: '不同领域内容混在一起，相互干扰',
      problem4: '完整性缺失',
      problem4Desc: '不关心知识是否完整，只管拆分检索',
      // OmniAgent解决方案
      solutionTitle: 'OmniAgent的解决方案',
      solution1: '角色驱动提取',
      solution1Desc: '预设角色和提示词，按需提取完整知识',
      solution2: 'AI智能分析',
      solution2Desc: '调用AI服务提取流程图、架构图、测试用例等',
      solution3: '依赖自动关联',
      solution3Desc: '检查知识依赖，从知识库获取相关内容',
      solution4: '知识补全机制',
      solution4Desc: '缺失内容自动提示，允许用户补充文档',
      // 架构层
      archTitle: '四层知识网络架构',
      layer1: '知识域层 - 独立向量空间',
      layer2: '知识网络层 - 跨域关联',
      ...
      // 知识域
      docDomain: '文档知识域',
      docDomainDesc: '技术文档、规范',
      codeDomain: '代码知识域',
      codeDomainDesc: '项目代码分析',
      roleDomain: '角色知识域',
      roleDomainDesc: '角色专属知识',
      bizDomain: '业务知识域',
      bizDomainDesc: '业务流程规则',
      // 知识网络功能
      crossDomain: '跨域关联',
      dependency: '依赖管理',
      completeness: '完整性检查',
      ...
      advTitle: '核心优势',
      adv1: '完整性保障',
      adv1Desc: '确保提取的知识完整、不遗漏关键信息',
      adv2: '依赖自动关联',
      adv2Desc: '自动发现和管理知识间的依赖关系',
      adv3: '结果可控',
      adv3Desc: '基于完整知识检索，结果可预测验证',
      adv4: '独立向量库',
      adv4Desc: '每个知识域独立向量空间，互不干扰',
      // 向量说明
      vectorQuestion: '是否有用到向量检索？',
      vectorAnswer: '当然有！知识网络使用独立的向量库，只是不再混乱无序。每个角色、每个知识域都有独立的向量空间，确保检索精准且结果可控。',
    },
    // 核心特性
    features: {
      title: '核心特性',
      domainIsolation: '知识域隔离',
      domainIsolationDesc: '每个知识域独立向量空间，避免知识混淆，提升检索精度50%+',
      multiDomain: '多域管理',
      smartRouting: '智能路由',
      permissionIsolation: '权限隔离',
      fullFormatSupport: '全格式文档支持',
      fullFormatSupportDesc: 'Office全家桶 + 所有文本格式，自动Markdown转换，完美适配LLM',
      officeDocs: 'Office: PDF, Word, Excel, PowerPoint',
      textDocs: '文本: TXT, MD, JSON, XML, CSV, LOG...',
      codeDocs: '代码: Java, Python, JS, C++... 所有编程语言',
      codeProjectKB: '支持构建代码项目独立知识库',
      sixChunkingStrategies: '6种分块策略',
      sixChunkingStrategiesDesc: '从简单到智能，根据文档类型自动选择最佳分块策略',
      fixedParaSentence: '固定长度/段落/句子',
      pplSmart: 'PPL智能分块',
      semanticTFIDF: '语义分块（TF-IDF）',
      vectorSearch: '向量化检索',
      vectorSearchDesc: '集成ONNX Runtime，支持本地Embedding，无需调用在线API',
      bgeBase: 'BGE-base-zh-v1.5',
      semanticSearch: '语义搜索',
      gracefulDegradation: '优雅降级',
      smartRoleKnowledge: '智能角色与知识网络',
      smartRoleKnowledgeDesc: '创建角色，通过角色描述智能构建提示词，自动生成专用知识库',
      aiPromptGen: 'AI智能提示词生成',
      roleKB: '角色专用知识库',
      knowledgeGraph: '知识图谱与跨域关联',
      codeProjectAnalysis: '代码项目智能分析',
      enterpriseArch: '企业级架构',
      enterpriseArchDesc: 'Spring Boot标准，可插拔设计，生产就绪',
      modularDesign: '20+模块化设计',
      exceptionHandling: '完整异常处理',
      compileSuccess: '编译100%通过',
    },
    // 应用场景
    useCases: {
      title: '全场景Agent应用',
      smartCodeAssistant: '智能代码助手',
      smartCodeAssistantDesc: '类似 GitHub Copilot / Cursor 的智能编程助手',
      fullProjectContext: '完整项目上下文',
      fullProjectContextDesc: '分析整个代码仓库，提供精准建议',
      smartCompletion: '代码智能补全',
      smartCompletionDesc: '基于项目风格和历史代码',
      bugDetection: 'Bug检测',
      bugDetectionDesc: '自动发现潜在问题并给出修复方案',
      docGeneration: '文档生成',
      docGenerationDesc: '自动生成API文档和注释',
      autoTestPlatform: '自动化测试平台',
      autoTestPlatformDesc: '智能测试用例生成与执行',
      testCaseGen: '测试用例自动生成',
      testCaseGenDesc: '基于代码逻辑生成测试',
      boundaryDetection: '边界条件识别',
      boundaryDetectionDesc: 'AI发现边界和异常场景',
      regressionTest: '回归测试',
      regressionTestDesc: '智能选择需要执行的测试',
      testReportAnalysis: '测试报告分析',
      testReportAnalysisDesc: '自动生成详细测试报告',
      projectAnalysisReport: '项目分析报告',
      projectAnalysisReportDesc: '深度项目洞察与优化建议',
      architectureAnalysis: '架构分析',
      architectureAnalysisDesc: '评估系统架构合理性',
      codeQuality: '代码质量',
      codeQualityDesc: '检测代码smell和反模式',
      securityAudit: '安全审计',
      securityAuditDesc: '发现安全漏洞和风险点',
      performanceOptimization: '性能优化',
      performanceOptimizationDesc: '识别性能瓶颈并给出建议',
      enterpriseAgentService: '企业Agent服务平台',
      enterpriseAgentServiceDesc: '构建分布式Agent服务生态',
      multiTenantIsolation: '多租户隔离',
      multiTenantIsolationDesc: '企业级安全和权限管理',
      agentMarketplace: 'Agent市场',
      agentMarketplaceDesc: '发布和订阅各类专业Agent',
      workflowOrchestration: '工作流编排',
      workflowOrchestrationDesc: '组合多个Agent完成复杂任务',
      apiGateway: 'API网关',
      apiGatewayDesc: '统一接口，灵活集成',
    },
    // 技术栈
    techStack: {
      title: '技术栈',
    ...
    // Footer
    footer: {
      aboutTitle: '关于 OmniAgent',
      aboutDesc: '基于知识域隔离的企业级智能知识管理平台，让每个领域的知识独立闪耀。',
      quickLinks: '快速链接',
      contactUs: '联系我们',
