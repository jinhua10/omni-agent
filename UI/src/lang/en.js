...
export default {
  ...
  ragFlow: {
    ...
    component: {
      ...
      selected: 'Selected',
      selectTemplate: 'Select Strategy Template',
      ...
      confirmDelete: 'Confirm Delete',
      confirmDeleteContent: 'Are you sure you want to delete strategy template "{name}"? This action cannot be undone.',
      templateDeleted: 'Template Deleted',
      deleteFailed: 'Delete Failed',
      templateApplied: 'Strategy Template Applied',
      applyFailed: 'Apply Failed',
      pleaseSelectTextExtraction: 'Please select text extraction method first',
      pleaseSelectChunkingStrategy: 'Please select chunking strategy first',
      cannotLoadConfig: 'Cannot load document configuration',
      ...
      templateSaved: 'Strategy Template Saved',
      saveFailed: 'Save Failed',
      startProcessingDoc: 'Start processing document: ',
      processingStarted: 'Processing started...',
      documentFlowTitle: 'Document Processing Flow: ',
      ...
      standardExtraction: 'Standard',
      visionLLM: 'Vision LLM',
      ocrRecognition: 'OCR Recognition',

      // Processing Stages
      stageUpload: 'Document Upload',
      stageExtract: 'Text Extraction',
      stageChunk: 'Smart Chunking',
  ...
  textExtractionConfig: {
    ...
    buttons: {
      ...
      reset: 'Reset',
      resetSuccess: 'Reset to original extraction result',
      noOriginalResult: 'No original result to reset',
      backToFlow: 'Back to Flow View',
      previousStep: 'Previous: Flow View',
  ...
  landingPage: {
    ...
    stats: {
      ...
      codeLines: 'Java Code',
      codeLinesUnit: '+ Lines',
      docFormats: 'Document Formats',
      docFormatsUnit: ' Types',
      chunkingStrategies: 'Chunking Strategies',
      chunkingStrategiesUnit: ' Types',
      ragSolutions: 'RAG Solutions',
      ragSolutionsUnit: ' Types',
      vectorModels: 'Vector Models',
      vectorModelsUnit: ' Types',
      storageEngines: 'Storage Engines',
      storageEnginesUnit: ' Types',
      multiInstance: 'Multi-Instance',
      multiInstanceUnit: ' Supported',
      modelIntegration: 'Model Integration',
      modelIntegrationUnit: ' Types',
      knowledgeNetwork: 'Knowledge Network',
      knowledgeNetworkUnit: ' Enabled',
      hope: 'HOPE',
      hopeUnit: ' Enabled',
      p2p: 'P2P',
      p2pUnit: ' Enabled',
      ...
      desc1: 'Modular Design · Enterprise-Grade Code Quality',
      desc2: 'Multi-Strategy RAG · Flexible Storage · Multi-Instance Support',
      desc3: 'Knowledge Network · Self-Learning · P2P Distributed',
      desc4: 'Latest Tech Stack · Ready to Use',
    },
    // Comparison Section
    comparison: {
      title: 'Why Choose OmniAgent?',
      traditionalDefect: '❌ Fundamental Flaws of Traditional RAG',
      singleVectorChaos: 'Single Vector Space Chaos',
      mixedDocs: '📄 Tech Docs + 📊 Financial Reports + 💼 Contracts + 📧 Emails...',
      // Problem points
      semanticFragmentation: 'Semantic Fragmentation',
      semanticFragmentationDesc: 'Fixed chunking destroys semantics',
      contextBreak: 'Context Break',
      contextBreakDesc: 'Cannot associate information across chunks',
      vectorPollution: 'Vector Space Pollution',
      vectorPollutionDesc: 'Multi-domain mixing reduces precision',
      singleStorage: 'Single Storage',
      singleStorageDesc: 'Single point of failure',
      fixedDimension: 'Fixed Dimension',
      fixedDimensionDesc: 'Cannot adapt to different scenarios',
      staticKnowledge: 'Static Knowledge',
      staticKnowledgeDesc: 'Lacks continuous learning',
      // Innovation points
      innovation: '✅ OmniAgent Architectural Innovation',
      domainIsolation: 'Knowledge Domain Isolation Architecture',
      techDocDomain: 'Tech Doc Domain',
      financeDomain: 'Financial Report Domain',
      contractDomain: 'Contract Domain',
      sixStrategies: '6 Chunking Strategies',
      semanticPreserved: 'Smart Semantic Preservation',
      domainIsolationFeature: 'Knowledge Domain Isolation',
      independentVector: 'Independent Vector Space',
      multiStorage: 'Multi-Storage',
      disasterBackup: 'Disaster Recovery Redundancy',
      multiDimension: 'Multi-Dimensional Vectors',
      parallelEmbedding: 'Parallel Embedding',
      knowledgeNetworkFeature: 'Knowledge Network',
      crossDomain: 'Cross-Domain Association',
      hopeArch: 'HOPE Architecture',
      selfLearning: 'Self-Learning Evolution',
      smartRole: 'Smart Roles',
      aiPrompts: 'AI-Generated Prompts',
      distributedArch: 'Distributed Architecture',
      highAvailability: 'High Availability Cluster',
    },
    // Workflow Section
    workflow: {
      title: 'Intelligent End-to-End Process',
      domainArchDetail: 'Knowledge Domain Isolation Architecture Details',
      knowledgeNetworkLayer: 'Knowledge Network Enhancement Layer',
      p2pArchTitle: 'P2P Distributed Architecture - Spreading Knowledge Through the Network',
      knowledgeExtraction: 'Knowledge Extraction',
      aiAnalysis: 'AI Intelligent Analysis',
      crossDomainAssociation: 'Cross-Domain Association',
      semanticGraph: 'Semantic Graph Construction',
      hopeLearning: 'HOPE Learning',
      selfOptimization: 'Self-Optimization Evolution',
      contextCompletion: 'Context Completion',
      qaEnhancement: 'Smart Q&A Enhancement',
      // Steps
      step1Title: '1. Document Upload',
      step1Highlight: 'Full Format Support',
      step1Detail1: '• Office: Word, Excel, PPT, PDF',
      step1Detail2: '• Text: TXT, MD, JSON, XML, CSV...',
      step1Detail3: '• Code: All programming languages',
      step2Title: '2. Intelligent Extraction',
      step2Highlight: 'Multiple Engines Available',
      step2Detail1: '• Local Model: Offline processing',
      step2Detail2: '• Ollama: Local deployment',
      step2Detail3: '• Online API: Qianwen 3-VL, etc.',
      step3Title: '3. Smart Chunking',
      step3Highlight: '6 Strategies Available',
      step3Detail1: '• Fixed Length / Paragraph / Sentence',
      step3Detail2: '• Perplexity Smart Chunking (Recommended)',
      step3Detail3: '• Semantic Chunking (TF-IDF)',
      step4Title: '4. Vectorization',
      step4Highlight: 'Multiple Methods Coexist',
      step4Detail1: '• ONNX Local Model: BGE Series',
      step4Detail2: '• Ollama: Local Vectorization',
      step4Detail3: '• Online API: OpenAI, Qianfan...',
      step4Detail4: '✓ Supports multiple RAG systems running simultaneously',
      step5Title: '5. Domain Index Construction',
      step5Highlight: 'Knowledge Domain Isolation Architecture',
      step5Detail1: '• Independent vector space per domain',
      step5Detail2: '• Avoid cross-domain interference',
      step5Detail3: '• Precise retrieval positioning',
      step6Title: '6. Multi-RAG Retrieval',
      step6Highlight: 'Multi-Strategy Parallel',
      step6Detail1: '• Vector Search + Keyword Search',
      step6Detail2: '• Result Fusion and Reranking',
      step6Detail3: '• Improve recall and accuracy',
      // Traditional Way
      traditionalWay: '❌ Traditional: Single Index Pool',
      traditionalDesc1: 'All documents mixed in one vector space',
      traditionalDesc2: 'Tech, finance, legal documents interfere with each other',
      traditionalDesc3: 'Low retrieval precision, high noise',
      // OmniAgent Way
      omniAgentWay: '✅ OmniAgent: Knowledge Domain Isolation',
      independentIndex: 'Independent Index',
      techDataDomain: 'Tech Doc Domain',
      financeDataDomain: 'Finance Data Domain',
      legalContractDomain: 'Legal Contract Domain',
      omniAgentDesc1: 'Independent vector space per domain',
      omniAgentDesc2: 'No interference, precise retrieval',
      omniAgentDesc3: '50%+ retrieval precision improvement',
      // P2P Section
      ...
      knowledgePropagationDesc: 'New knowledge automatically pushed to connected nodes, continuous learning and evolution',
    ...
    knowledgeNetworkArch: {
      title: 'Knowledge Network Architecture',
      subtitle: 'Role-Driven Complete Knowledge Extraction + Independent Vector Libraries = Controllable Intelligent Retrieval',
      // Traditional RAG Problems
      traditionalTitle: 'Traditional RAG Dilemma',
      problem1: 'Content Fragmentation',
      problem1Desc: 'Fixed chunking destroys semantic integrity, context lost',
      problem2: 'Random Results',
      problem2Desc: 'Without large-scale training, retrieval results unpredictable',
      problem3: 'Knowledge Chaos',
      problem3Desc: 'Different domains mixed together, interfering each other',
      problem4: 'Completeness Missing',
      problem4Desc: 'Does not care about knowledge completeness, just splits and retrieves',
      // OmniAgent Solutions
      solutionTitle: 'OmniAgent Solution',
      solution1: 'Role-Driven Extraction',
      solution1Desc: 'Preset roles and prompts, extract complete knowledge on demand',
      solution2: 'AI Smart Analysis',
      solution2Desc: 'Call AI to extract flowcharts, architecture diagrams, test cases, etc.',
      solution3: 'Auto Dependency Linking',
      solution3Desc: 'Check dependencies, get related content from knowledge base',
      solution4: 'Knowledge Completion',
      solution4Desc: 'Auto-prompt for missing content, allow users to supplement',
      // Architecture Layers
      archTitle: 'Four-Layer Knowledge Network Architecture',
      layer1: 'Knowledge Domain Layer - Independent Vector Space',
      layer2: 'Knowledge Network Layer - Cross-Domain Association',
      layer3: 'Role Knowledge Extraction Layer',
      layer4: 'RAG Intelligent Retrieval Layer',
      // Knowledge Domains
      docDomain: 'Document Domain',
      docDomainDesc: 'Tech docs, specs',
      codeDomain: 'Code Domain',
      codeDomainDesc: 'Project code analysis',
      roleDomain: 'Role Domain',
      roleDomainDesc: 'Role-specific knowledge',
      bizDomain: 'Business Domain',
      bizDomainDesc: 'Business processes',
      // Network Features
      ...
      // Extraction Steps
      step1Title: 'Define Role',
      step1Desc: 'Set role prompts',
      step2Title: 'AI Extract',
      step2Desc: 'Smart extraction',
      step3Title: 'Check Deps',
      step3Desc: 'Get related knowledge',
      step4Title: 'Complete',
      step4Desc: 'Fill missing content',
      // RAG Capabilities
      cap1: 'Precise Location',
      cap1Desc: 'Search in complete knowledge',
      cap2: 'Vector Search',
      cap2Desc: 'Independent vector query',
      cap3: 'Controllable Results',
      cap3Desc: 'Completeness guaranteed',
      cap4: 'Quality Assured',
      cap4Desc: 'Network validated',
      // Advantages
      advTitle: 'Core Advantages',
      adv1: 'Completeness Guarantee',
      adv1Desc: 'Ensure extracted knowledge is complete, no key info missing',
      adv2: 'Auto Dependency Linking',
      adv2Desc: 'Auto-discover and manage dependencies between knowledge',
      adv3: 'Controllable Results',
      adv3Desc: 'Retrieve from complete knowledge, predictable results',
      adv4: 'Independent Vector Libraries',
      adv4Desc: 'Each domain has independent vector space, no interference',
      // Vector Note
      vectorQuestion: 'Does it use vector search?',
      vectorAnswer: 'Of course! The knowledge network uses independent vector libraries, just no longer chaotic and disorganized. Each role and domain has its own vector space, ensuring precise and controllable retrieval.',
    },
    // Features Section
    features: {
      title: 'Core Features',
      domainIsolation: 'Knowledge Domain Isolation',
      domainIsolationDesc: 'Each knowledge domain has independent vector space, avoiding knowledge confusion, improving retrieval precision by 50%+',
      multiDomain: 'Multi-Domain Management',
      smartRouting: 'Smart Routing',
      permissionIsolation: 'Permission Isolation',
      fullFormatSupport: 'Full Format Document Support',
      fullFormatSupportDesc: 'Office Suite + All text formats, auto Markdown conversion, perfect LLM adaptation',
      officeDocs: 'Office: PDF, Word, Excel, PowerPoint',
      textDocs: 'Text: TXT, MD, JSON, XML, CSV, LOG...',
      codeDocs: 'Code: Java, Python, JS, C++... All programming languages',
      codeProjectKB: 'Support building independent knowledge base for code projects',
      sixChunkingStrategies: '6 Chunking Strategies',
      sixChunkingStrategiesDesc: 'From simple to intelligent, automatically select best chunking strategy based on document type',
      fixedParaSentence: 'Fixed Length / Paragraph / Sentence',
      pplSmart: 'PPL Smart Chunking',
      semanticTFIDF: 'Semantic Chunking (TF-IDF)',
      vectorSearch: 'Vectorization Search',
      vectorSearchDesc: 'Integrated ONNX Runtime, supports local Embedding, no need for online API',
      bgeBase: 'BGE-base-zh-v1.5',
      semanticSearch: 'Semantic Search',
      gracefulDegradation: 'Graceful Degradation',
      smartRoleKnowledge: 'Smart Roles & Knowledge Network',
      smartRoleKnowledgeDesc: 'Create roles, intelligently build prompts via role descriptions, auto-generate specialized knowledge base',
      aiPromptGen: 'AI Smart Prompt Generation',
      roleKB: 'Role-Specific Knowledge Base',
      knowledgeGraph: 'Knowledge Graph & Cross-Domain Association',
      codeProjectAnalysis: 'Code Project Smart Analysis',
      enterpriseArch: 'Enterprise Architecture',
      enterpriseArchDesc: 'Spring Boot standard, pluggable design, production-ready',
      modularDesign: '20+ Modular Design',
      exceptionHandling: 'Complete Exception Handling',
      compileSuccess: '100% Compilation Success',
    },
    // Use Cases Section
    useCases: {
      title: 'All-Scenario Agent Applications',
      smartCodeAssistant: 'Smart Code Assistant',
      smartCodeAssistantDesc: 'Intelligent coding assistant like GitHub Copilot / Cursor',
      fullProjectContext: 'Complete Project Context',
      fullProjectContextDesc: 'Analyze entire codebase, provide precise suggestions',
      smartCompletion: 'Smart Code Completion',
      smartCompletionDesc: 'Based on project style and historical code',
      bugDetection: 'Bug Detection',
      bugDetectionDesc: 'Auto-detect potential issues and provide fix solutions',
      docGeneration: 'Documentation Generation',
      docGenerationDesc: 'Auto-generate API docs and comments',
      autoTestPlatform: 'Automated Testing Platform',
      autoTestPlatformDesc: 'Smart test case generation and execution',
      testCaseGen: 'Auto-Generate Test Cases',
      testCaseGenDesc: 'Generate tests based on code logic',
      boundaryDetection: 'Boundary Condition Detection',
      boundaryDetectionDesc: 'AI discovers boundaries and edge cases',
      regressionTest: 'Regression Testing',
      regressionTestDesc: 'Intelligently select tests to run',
      testReportAnalysis: 'Test Report Analysis',
      testReportAnalysisDesc: 'Auto-generate detailed test reports',
      projectAnalysisReport: 'Project Analysis Report',
      projectAnalysisReportDesc: 'Deep project insights and optimization suggestions',
      architectureAnalysis: 'Architecture Analysis',
      architectureAnalysisDesc: 'Evaluate system architecture rationality',
      codeQuality: 'Code Quality',
      codeQualityDesc: 'Detect code smells and anti-patterns',
      securityAudit: 'Security Audit',
      securityAuditDesc: 'Discover security vulnerabilities and risks',
      performanceOptimization: 'Performance Optimization',
      performanceOptimizationDesc: 'Identify performance bottlenecks and provide suggestions',
      enterpriseAgentService: 'Enterprise Agent Service Platform',
      enterpriseAgentServiceDesc: 'Build distributed Agent service ecosystem',
      multiTenantIsolation: 'Multi-Tenant Isolation',
      multiTenantIsolationDesc: 'Enterprise-level security and permission management',
      agentMarketplace: 'Agent Marketplace',
      agentMarketplaceDesc: 'Publish and subscribe to various professional Agents',
      workflowOrchestration: 'Workflow Orchestration',
      workflowOrchestrationDesc: 'Combine multiple Agents to complete complex tasks',
      apiGateway: 'API Gateway',
      apiGatewayDesc: 'Unified interface, flexible integration',
    },
    // Tech Stack Section
    techStack: {
      title: 'Tech Stack',
    ...
    quickStart: {
      ...
      step1Title: 'Clone Project (Choose One)',
      step1Code1: '# GitHub',
      step1Code2: 'git clone https://github.com/jinhua10/omni-agent.git',
      step1Code3: '# Or Gitee (Recommended for China)',
      step1Code4: 'git clone https://gitee.com/gnnu/omni-agent.git',
      step2Title: 'Start Backend',
      step2Code1: 'mvn clean install -DskipTests',
      step2Code2: 'cd omni-agent-example-basic',
      step2Code3: 'mvn spring-boot:run',
      step3Title: 'Start Frontend',
      step3Code1: 'cd UI',
      step3Code2: 'npm install',
      step3Code3: 'npm run dev',
      demoButton: 'Try Online Demo',
    },
    // Footer Section
    footer: {
      aboutTitle: 'About OmniAgent',
      aboutDesc: 'Enterprise intelligent knowledge management platform based on knowledge domain isolation, letting every domain\'s knowledge shine independently.',
      ...
      githubLink: 'GitHub',
      giteeLink: 'Gitee',
      techBlogLink: 'Tech Blog',
      qrCodes: 'Scan to Support',
