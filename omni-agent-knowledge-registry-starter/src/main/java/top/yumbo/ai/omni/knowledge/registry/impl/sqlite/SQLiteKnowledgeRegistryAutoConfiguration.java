...
import top.yumbo.ai.omni.knowledge.registry.sqlite.SQLiteKnowledgeRegistryProperties;
...
@EnableConfigurationProperties(SQLiteKnowledgeRegistryProperties.class)
public class SQLiteKnowledgeRegistryAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean(KnowledgeRegistry.class)
    public KnowledgeRegistry knowledgeRegistry(
            JdbcTemplate jdbcTemplate,
            SQLiteKnowledgeRegistryProperties properties) {
